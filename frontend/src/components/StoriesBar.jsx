...
const StoriesBar = () => {
    ...
    return (
        <div className="w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scroll-bar overflow-x-auto px-4">
...
active:scale-95 `}
                    >
                        ...
                        />
                        <p className="absolute top-[72px] left-3 text-white/60 text-sm truncate max-w-24">
                            {story.content}
                        </p>
