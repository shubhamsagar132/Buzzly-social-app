...
const navigate=useNavigate()
  ...
  return (
   <div  on onClick={()=>navigate('/profile/'+post.user._id)}class='bg-white rounded-xl shadow p-4 space-y-4 w-full max-w-2xl'>
  {/* User Info */}
  <div class='inline-flex items-center gap-3 cursor-pointer'>
    <img src={post.user.profile_picture} alt="" class='w-10 h-10 rounded-full shadow'/>
    <div>
